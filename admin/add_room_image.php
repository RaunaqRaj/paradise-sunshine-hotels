                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" id="add_room_image" action="#" method="post">
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                    <select name="room" id="room_id" class="form-control select">
                                                    <?php 
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="val-currency">Room Image
