                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4 style="color : #f48f1b;">Payment Cards</h4>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="home.php">Dashboard</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Payment Cards</a></li>
                        </ol>
                    </div>
                </div>
 ...
 <div class="modal fade" id="UpdateModal" tabindex="-1" aria-labelledby="ReplyModalLabel" aria-hidden="true">
  <div class="modal-dialog">
      ...
      <div class="modal-body">
        <form>
          <div class="mb-3">
            ...
            <label for="recipient-name" class="col-form-label text-dark">First Name</label>
                                    ...
                                    <table id="example" class="display text-center table-striped " style="min-width: 845px; color:black;">
                                        <thead class="table-primary">
                                            <tr>
                                                ...
                                                <th class="text-dark">Card Number</th>
    ...
    ***********************************-->
    ...
    <script src="./js/payment_card.js"></script>
