...
<body>
  ...
  <div class="container">
    <section class="mb-4">
      ...
      <div class="row" style="background: url(assests/images/3956344.jpg); padding: 50px; border-radius: 40px;">
        <div class="col-md-9 mb-md-0 mb-5" style="background-color: #fff; border-radius: 60px; padding: 40px; ">
          <img src="assests/images/3956344.jpg" alt="" style="width: 300px; float: right; border-radius: 50px;">
          <form action="contact.php" method="post">
         <?php echo json_encode(array("success" => true, "message" => "Your details has been sent successfully!"));
                die;
            ...
            <div class="row">
              <div class="col-md-8">
                <div class="md-form">
                  ...
                  <input name="name" id="name" type="" class="form-control"  autocomplete="off" placeholder="enter your name"
                ...
                <div class="col-md-12">
                  <div class="md-form">
                    <label for="email"style="color:#ff9800; font-size: 23px; font-weight: 700;" class="mt-3">email</label>
                    <input name="email" id="email" placeholder="enter your email" type="" class="form-control"autocomplete="off"
                      style="border-top: 0; border-left: 0; border-right: 0; outline-style: none;" >
              ...
              <div class="row">
                <div class="col-md-8">
                  <div class="md-form">
                    <label for="subject" style="color:#ff9800; font-size: 23px; font-weight: 700;" id="sub" class="mt-3">subject</label>
                    <input type="text" id="subject" placeholder="Your consideration" name="subject"
                      class="form-control" autocomplete="off"
                      style="border-top: 0; border-left: 0; border-right: 0; align-items: center;">
                ...
                <div class="row">
                  <div class="col-lg-10">
                    <div class="md-form">
                      <label for="message" style="color:#ff9800; font-size: 23px; font-weight: 700;" class="mt-3">Message</label>
                ...
                <div class=" text-md-left mt-2">
                  <input type="submit" name="submit" class="btn btn-primary" style="background-color:#ff9800;" id="btn"/>
                </div>
